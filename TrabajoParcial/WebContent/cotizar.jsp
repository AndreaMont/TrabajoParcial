...
<body>
								...
								<div class="form">
									...
									<form action="register" method="post">
										<input type="text" name="nombre" placeholder="Nombres"
											required=""> <input type="text" name="apellido"
	...
	<div class="faq">
		...
		<div class="container" align="center">
			...
			<div class="row">
				<form class="form" action="agregarCotizacion" method="post">

					<div class="control-group">
						<label class="control-label">MODELO:</label> <input type="text"
							name="modelo" id="modelo" placeholder="" value="">
					...
					<div class="control-group">
						<label class="control-label">MARCA:</label> <input type="text"
							name="marca" id="marca" placeholder="" value="">
					...
					<div class="control-group">
						...
						<label class="control-label">AÑO:</label> <input type="text"
							name="anio" id="anio" placeholder="" value="">
					</div>
